<?php
  $sql = "SELECT * FROM danhmuc WHERE iddm = '$_GET[id]' ";
...
<div class="main p-3">
    <div class="text-center">
        <section class="container my-2 bg-secondary w-50 text-light p-2">
            ...
            <form class="row g-3 p-3" method="POST" action="index.php?quanly=xulythemdanhmuc&id=<?php echo $row['iddm'] ?>" enctype="multipart/form-data">
                <div class="col-md-12">
                    <label for="validationDefault01" class="form-label">Tên danh mục</label>
                    <input type="text" class="form-control" id="validationDefault01" name="tendanhmuc" placeholder="Tên danh mục" value="<?php echo $row['tendm'] ?>">
                </div>
                <div class="col-12">

...
$totalItem = mysqli_fetch_assoc($conn->query("SELECT COUNT(*) as total FROM sanpham WHERE iddm = 1"))['total'];
$itemPerPage = 8;
...
?>
        ...
        <div class="shop">
            <div class="shop-hihi">
                ...
                <div class="phantrang">
                    <a href="index.php?pid=2&page=1"> Trang đầu </a>
                    ...
                    <a href="index.php?pid=2&page=<?php echo $totalPage ?>"> Trang cuối </a>
                </div>
            </div>
        </div>
    <?php
